...
TBLPROPERTIES ('parquet.enable.bloom.filter'='true', 'parquet.bloom.filter.enable.column.names'='c_customer_sk', 'parquet.bloom.filter.expected.entries'='1000000')
AS
...
STORED AS ${hiveconf:tableFormat}
TBLPROPERTIES ('parquet.enable.bloom.filter'='true', 'parquet.bloom.filter.enable.column.names'='i_item_sk', 'parquet.bloom.filter.expected.entries'='10000')
AS
...
STORED AS ${hiveconf:tableFormat}
TBLPROPERTIES ('parquet.enable.bloom.filter'='true', 'parquet.bloom.filter.enable.column.names'='ss_sold_date_sk,ss_store_sk,ss_item_sk', 'parquet.bloom.filter.expected.entries'='100000,1000,100000')
AS
...
STORED AS ${hiveconf:tableFormat}
TBLPROPERTIES ('parquet.enable.bloom.filter'='true', 'parquet.bloom.filter.enable.column.names'='sr_returned_date_sk,sr_store_sk,sr_item_sk', 'parquet.bloom.filter.expected.entries'='100000,1000,100000')
AS
...
STORED AS ${hiveconf:tableFormat}
TBLPROPERTIES ('parquet.enable.bloom.filter'='true', 'parquet.bloom.filter.enable.column.names'='ws_sold_date_sk,ws_web_page_sk,ws_item_sk', 'parquet.bloom.filter.expected.entries'='100000,1000,100000')
AS
...
STORED AS ${hiveconf:tableFormat}
TBLPROPERTIES ('parquet.enable.bloom.filter'='true', 'parquet.bloom.filter.enable.column.names'='wr_returned_date_sk,wr_web_page_sk,wr_item_sk', 'parquet.bloom.filter.expected.entries'='100000,1000,100000')
AS
...
STORED AS ${hiveconf:tableFormat}
TBLPROPERTIES ('parquet.enable.bloom.filter'='true', 'parquet.bloom.filter.enable.column.names'='wcs_click_date_sk,wcs_item_sk,wcs_web_page_sk', 'parquet.bloom.filter.expected.entries'='100000,100000,1000')
AS
